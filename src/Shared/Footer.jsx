...
const Footer = (props) => {
    return (
        ...
        <div className='mt-4 pt-4 border-t-2 border-black bg-black'>
            <h1 className="font-bold text-4xl text-center text-blue-500 ">Winter Donation</h1>
            <p className="text-gray-400 text-center">Donate Your used Cloth to save from cold</p>
